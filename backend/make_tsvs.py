...
def make_tsvdirs():
    ...
    for chrom in chrom_lst:
        ...
        tsvchr_path = os.path.join(configs.TSV_DIR, chrom)
...
def get_tsvs(chrom, incomplete=False, model_fp=configs.MODEL_PATH):
    ...
    >>> first couple of rows of PDCD1.tsv
      chrom pamid    genename  num      start        end strand        pos         varid ref alt  inx  ...  ref_1del  alt_1del diff_1del ref_onemod3  alt_onemod3  diff_onemod3  ref_twomod3  alt_twomod3  diff_twomod3  ref_frameshift  alt_frameshift  diff_frameshif0     
      chr2  PDCD1|57    PDCD1   57  241851253  241851313      +  241851283  rs1284638279   T   G   30  ...  0.032371  0.160016 -0.127645    0.699742     0.338150      0.361592     0.171198     0.383210     -0.212012        0.863511        0.718307         0.145204
