...
cd /home/lingj/zhanglab/jling/CROTONdb

# Run make_beds.py
python backend/make_beds.py --chrom $1

# Run make_tsvs.py
if [[ $? = 0 ]]; 
    then 
        echo "Finished making beds!"
       python backend/make_tsvs.py --chrom $1
else
...
if [[ $? = 0 ]]; 
    ...
    python backend/make_tabix.py --chrom $1
else 
...
if [[ $? = 0 ]]; 
    ...
    cd zhanglab/lingj/CROTONdb/datavl/variant/tabix
